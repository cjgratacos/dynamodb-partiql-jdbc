...
/**
 * ResultSet implementation for Lambda function results.
 * 
 * <p>This class wraps the result data returned from a Lambda function
 * and provides a standard JDBC ResultSet interface.
 * 
 * @author CJ Gratacos
 * @since 1.0
 */
public class LambdaResultSet implements ResultSet {
    
    private final List<Map<String, Object>> data;
    private final LambdaResultSetMetaData metaData;
    private int currentRow = -1;
    private boolean closed = false;
    private boolean wasNull = false;
    
    /**
     * Creates a new Lambda result set.
     * 
     * @param data the result data from Lambda function
     */
    public LambdaResultSet(List<Map<String, Object>> data) {
        this.data = data;
        this.metaData = new LambdaResultSetMetaData(data);
    }
    ...
    public boolean isBeforeFirst() throws SQLException {
        checkClosed();
        return currentRow == -1 && !data.isEmpty();
    }
    
    @Override
    public boolean isAfterLast() throws SQLException {
        checkClosed();
        return currentRow >= data.size() && !data.isEmpty();
    }
    ...
    private Object getValue(String columnLabel) throws SQLException {
        ...
        return data.get(currentRow).get(columnLabel);
    }
    ...
    public Date getDate(int columnIndex, Calendar cal) throws SQLException {
        throw new SQLFeatureNotSupportedException("Calendar not supported");
    }
    ...
    // Update methods - all throw exception as result set is read-only
